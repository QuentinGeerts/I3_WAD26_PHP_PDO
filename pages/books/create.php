...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  // Insertion d'un livre dans la DB si pas d'erreur
  ...
  if (!$errors) {
    ...
    try {
      ...
      $statement->execute([
        $values['book-title'],
        $values['book-published-year'] !== '' ? $values['book-published-year'] : null,
        $values['book-price'] !== '' ? $values['book-price'] : null,
      ...
      header('Location: index.php?page=book-details&id=' . $newBookId);
